...
if __name__ == "__main__":
    ...
    game.infoGame()
    # list = []
    # list.append(Sequence("halo",30))
    # list.append(Sequence("aku",20))
    # list.append(Sequence("der",10))
    # test = Sequence("7ABD7ABD1CBD55", 0)
    # # print(list(test.string))
    # print(test.countSubstring("BDE91C"))
    # print(test.countSubstring("BD7ABD"))
    # print(test.countSubstring("BD1CBD55"))
    # print(test.getPoint(game.sequence, 3))
    start = time.time()
    game.solution()
    end = time.time()
